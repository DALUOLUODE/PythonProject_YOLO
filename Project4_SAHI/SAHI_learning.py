...
# 获取预测结果
prediction_without_slicing = get_prediction(data_path + "/small-vehicles1.jpeg",model)
prediction_with_slicing = get_sliced_prediction(data_path + "/small-vehicles1.jpeg",
                                                model,
                                                slice_height = 256,
                                                slice_width = 256,
